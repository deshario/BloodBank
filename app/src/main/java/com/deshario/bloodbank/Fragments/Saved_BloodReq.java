...
import com.deshario.bloodbank.Adapters.SavedBloodReqAdapter;
 ...
 */
public class Saved_BloodReq extends Fragment {
    ...
    private void fetchRequest(int id){
        final String url = WEBAPI.GET_SAVED_BLOOD_REQ+id;
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status == "true"){
                                ...
                                List<SavedBloodRequest> savedBloodRequestList = parseJsonFeed(response);
                                SavedBloodReqAdapter savedBloodReqAdapter = new SavedBloodReqAdapter(savedBloodRequestList);
                                recyclerView.setAdapter(savedBloodReqAdapter);
                            } else {
...
//            }
    ...
    private List<SavedBloodRequest> parseJsonFeed(JSONObject response){
        List<SavedBloodRequest> savedBloodRequestList;
        SavedBloodRequest savedBloodRequest = new SavedBloodRequest();
        ...
        savedBloodRequestList = savedBloodRequest.setDatafromJson(jsonArray);
        return savedBloodRequestList;
    }
