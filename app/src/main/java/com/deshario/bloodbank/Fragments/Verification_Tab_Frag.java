...
public class Verification_Tab_Frag extends Fragment {
    ...
    private final int[] ICONS = new int[]{
            ...
            R.drawable.ic_pin_drop_white_36dp
    };

    public Verification_Tab_Frag() {
    ...
    private void setToolbar() {
        ...
        if (actionBar != null) {
            actionBar.setTitle(" Verifications");
    ...
    private class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new Saved_BloodReq();
                case 1:
                    return new Saved_BranchReq();
            }
            return null;
        }
